 ...
 */
class InternshipLocationFlagDeserializer : JsonDeserializer<InternshipLocationFlagDto> {
    override fun deserialize(
        json: JsonElement,
        typeOfT: Type,
        context: JsonDeserializationContext
    ): InternshipLocationFlagDto {
        ...
        val imageProfile = try {
            ...
            Log.e("InternshipLocationFlagDeserializer", "Error al obtener 'imageProfile': ${e.message}")
            "empty"
        }
        ...
        return InternshipLocationFlagDto(idInternshipLocation, locationCompanyDto, internshipDto, requested)
    }
}